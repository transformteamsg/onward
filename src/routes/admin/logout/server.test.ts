...
describe('POST /admin/logout', () => {
  ...
  test('redirects to /admin/login when unauthenticated', async () => {
  ...
  test('signs the admin out on a valid token', async () => {
  ...
  test('redirects to /admin/login when sign-out fails', async () => {
